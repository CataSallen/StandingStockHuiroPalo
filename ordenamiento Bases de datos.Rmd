...
BiomassplotYear<-ggplot(Site, aes(x= fct_relevel(Season, "Fall2012", "Spring2012","Fall2013", "Spring2013", y=meanB))) + geom_bar(position = "dodge", stat = "identity", size =.2)+
labs(x= "Season" ,y="Biomasa/m2")+
geom_errorbar(aes(ymin=meanB-sd, ymax= meanB+sd),width=.2,
position=position_dodge(.9))+ theme_classic()+facet_wrap(Site~., ncol=1)
